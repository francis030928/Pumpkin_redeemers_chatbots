...
# df = pd.read_csv(r'C:\Users\HP\OneDrive\Documents\Data_Science\Projects\streamlit dev\chatbot_dev\full_dialogs.txt', sep='\t', header=None, names=['question', 'answer', 'extra'])
